...
from helper import checkstate,checkstateBlue, statemachine,statemachine2,statemachine3, collision_avoidance, checkstate2, checkstate3, statemachinepathbacksecstage #import helper file
...
#             print("Middle Sensor = inches={}".format(pwi3))
            ...
            #needs to constantly be checking
                #print("ultrasonic_repeat is being reset")
                ultrasonic_repeat=False
...
#         time.sleep(0.3)
    ...
    #             #Control motor from pathfinding values
                ...
                print("pathfinding back is running")
            if(redcounter == 0):
                if(close_state1 == 1 and close_state2 == 1 and close_state3 ==1):
                    endloop -= 1
                    redcounter +=1
